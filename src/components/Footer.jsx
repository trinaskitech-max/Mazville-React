    ...
    <footer className="text-white content-info bg-navy-dark transition-all duration-500">
      ...
      <div className="flex flex-col gap-16 pb-16 mx-auto px-fluid-sm md:flex-row max-w-7xl">
        ...
        <div className="space-y-5 text-center md:text-left contact">
          ...
          <p>
            <a
              ...
              className="transition-all duration-300 hover:text-blue hover:translate-x-1 inline-block"
            >
              +91 81234 56789
            </a>
            <br />
            <em>
              <a
                className="transition-all duration-500 hover:text-blue hover:translate-x-1 inline-block"
                href="mailto:info@mazvillemedhaya.com"
              >
                info@mazvillemedhaya.com
              </a>
            </em>
          </p>
          <p>
        ...
        <div className="space-y-5 text-center md:text-left address">
          ...
          <p className="">
            <a
              href="https://maps.app.goo.gl/YzavfZ18H8VVZ8eR6"
              className="block"
              target="_blank"
              rel="noopener noreferrer"
            >
              <span className="font-mono transition-colors duration-500 hover:text-blue">
                Get Directions
              </span>
            </a>
          ...
          <nav className="w-full">
            <ul className="flex items-center justify-center sm:justify-start gap-6 pt-4">
              <li>
                <a
                  target="_blank"
                  href="https://www.instagram.com/stagecoachsalado/"
                  rel="noopener noreferrer"
                >
              ...
              <li>
                <a
                  target="_blank"
                  href="https://www.facebook.com/stagecoachsaladotx/"
                  rel="noopener noreferrer"
                >
